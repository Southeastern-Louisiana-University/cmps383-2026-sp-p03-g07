...
const featuredProfiles: StoreProfile[] = [
  {
    ...
    pickup: "Pickup and dine-in",
    feature: "Fastest stop for commuter coffee, early classes, and walk-up pickup.",
    blurb: "Built for quick orders, weekday studying, and a reliable first pour before campus wakes up.",
    phone: "985 555 0101",
  ...
  },
  {
    ...
    pickup: "Pickup and dine-in",
    feature: "Compact pilot cafe built for all-day foot traffic and fast order handoff.",
    blurb: "A city-ready room with lighter seating, quick pickup shelves, and an easy grab-and-go flow.",
    phone: "212 555 0102",
    directoryName: ["Pilot Cafe", "& Bakery"],
    weeklyHours: [
  ...
  },
  {
    ...
    pickup: "Pickup and dine-in",
    feature: "Best fit for team orders, laptops, and bigger meetup tables.",
